        ...
        <VerticalTimeline lineColor={"black"}>
          ...
          >
            <Tooltip placement="top" content={onHoverDetails(BobbleAI)}>
              <Text css={{
                color: 'white',
              }} h3 className="vertical-timeline-element-title">Bobble AI</Text>
              <Text css={{
                color: 'white',
              ...
              <Text css={{
                color: 'white',
              }} p>Full Stack Developer Intern</Text>
            </Tooltip>
          </VerticalTimelineElement>
          ...
          >
            ...
            <Text css={{
                color: 'white',
              }} p>Software Developer Intern</Text>
            </Tooltip>
          </VerticalTimelineElement>
          <VerticalTimelineElement
            className="vertical-timeline-element--work"
          ...
          >
            ...
            <Text css={{
                color: 'white',
              }} p>B.Tech:- Information Technology</Text>
            <Text css={{
                color: 'white',
              }} p>CGPA:- 9.20</Text>
          </VerticalTimelineElement>
          ...
          >
            ...
            <Text css={{
                color: 'white',
              }} p>High Secondary</Text>
            <Text css={{
                color: 'white',
              }} p>PCM</Text>
              <Text css={{
                color: 'white',
              }} p>Percentage : 85%</Text>
          </VerticalTimelineElement>
        </VerticalTimeline>
      </Grid.Container>
    </Box>
